...
class hplControl():
    ...
    def init_vars(self, x, N, accel):
        ...
        self.lr = 0.13
        self.Iz = 0.02723
        self.Df = 0.9 * self.mass * 9.81 / 2.0
        self.Cf = 2.28
        self.Bf = 5.0
        self.Dr = 0.9 * self.mass * 9.81 / 2.0
        self.Cr = 2.28
        self.Br = 5.0
        ...
        self.opti.subject_to(self.opti.bounded(-0.4, self.u1, 0.4))
        ...
        self.opti.subject_to(self.opti.bounded(-0.4, self.x3, 0.4))
